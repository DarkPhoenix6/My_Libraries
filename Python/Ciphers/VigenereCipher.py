...
class CrackVigenere(FrequencyAnalysis):
    ...
    def hack_vigenere(self, ciphertext):
        ...
        print(all_likely_key_lengths)
        for key_length in all_likely_key_lengths:
            print(key_length)
            encryption_break_dict = self.attempt_hack_with_key_of_length_n(ciphertext, key_length,
                                                                           encryption_break_dict)
            if encryption_break_dict:
